namespace COMP003A.Assignment6
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Vehicle vehicle = new Truck("GMC", "Sierra 1500 AT4", 6, 5.5);
            vehicle.GetInfo();
            ...
            Vehicle Vehicle = new Truck(truckNumberOfWheels: 4, truckBrand: "Ford", truckModel: "f-150 Raptor", sizeOfTruckBed: 5.5);
            vehicle4.GetInfo();
        }
        ////<summary>
